...
const Card = ({event}) => {
    ...
    return ( 
        <div id={event.eventId.toString()} className="card-container w-full flex mb-5 p-2 gap-3 justify-between">
                    ...
                    <Link className="card min-w-[80%] p-4 flex gap-1 m:gap-3 justify-between shadow-lg rounded-3xl backdrop:blur-xl flex-grow" to={`/event/${event.eventId}`}>
                        <div className="event-details w-[70%] md:w-full flex flex-col gap-2">
                        ...
                        <div className="event-img w-[100px] h-[100px] md:w-[120px] md:h-[120px] rounded-2xl overflow-hidden relative">
